...
public class ClientUDP extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnPrime.setText("Tìm số nguyên tố");
        ...
        btnFibo.setText("Tìm dãy fibonacci");
    ...
    private void btnPrimeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrimeActionPerformed
        try {
            DatagramPacket packet = new DatagramPacket(Constant.ACL_PRIME.getBytes(), Constant.ACL_PRIME.getBytes().length,Inet4Address.getLocalHost(),ServerUDP.PORT);
            socket.send(packet);
    ...
    private void btnFiboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFiboActionPerformed
        try {
            DatagramPacket packet = new DatagramPacket(Constant.ACL_FIBO.getBytes(), Constant.ACL_FIBO.getBytes().length,Inet4Address.getLocalHost(),ServerUDP.PORT);
            socket.send(packet);
            
            DatagramPacket packet1 = new DatagramPacket(txtIn.getText().trim().getBytes(), txtIn.getText().trim().getBytes().length,Inet4Address.getLocalHost(),ServerUDP.PORT);
            socket.send(packet1);
